...
def drop_block2d(
    ...
    #     torchvision.utils._log_api_usage_once(drop_block2d)
    if p < 0.0 or p > 1.0:
...
class DropBlock(nn.Module):
    """
    Implementation of paper: https://arxiv.org/abs/1180.12890
    It works like dropout, but square blocks are dropped instead of single pixels.

    args:
            block_size int: shape of the square mask
            p float: keep probability (should be around 0.7 and 0.9)
    """
